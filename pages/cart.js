        ...
        <table className={styles.table}>
          <tbody>
            ...
            {cart.products.map((product, index) => (
              <tr className={styles.trItem} key={index}>
                <td>
      ...
      <div className={styles.right}>
        <div className={styles.wrapper}>
          ...
          <div className={styles.totalText}>
            <b className={styles.totalText__title}>Subtotal:</b>${cart.total}
          </div>
          <div className={styles.totalText}>
            <b className={styles.totalText__title}>Discount:</b>$00.00
          </div>
          <div className={styles.totalText}>
            <b className={styles.totalText__title}>Total:</b>${cart.total}
          </div>
          ...
          {open ? (
            <div className={styles.payment}>
              ...
              <PayPalScriptProvider
                options={{
                  "client-id":
                    "AZrZSAs6QdAIuCXzFLiZJibBn0AGnjknANQco8arJqfGWeG_J4QGC1PxYzCMIpZqSwEKFCOvvFwKL1Hz",
                  components: "buttons",
                  currency: "USD",
                }}
              >
